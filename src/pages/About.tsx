    ...
    const sections = [
        {
            ...
            content: (
                <div className="w-full h-full flex flex-col items-center justify-center px-6 text-center space-y-6 pt-20">
        ...
        },
        {
            ...
            content: (
                <div className="w-full h-full flex flex-col items-center justify-center px-6 lg:px-20 space-y-12">
                    <h2 className="text-5xl font-extrabold text-white">Engineering Excellence</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-6">
                        <div className="bg-gradient-to-tr from-gray-800 to-gray-700 p-8 rounded-2xl shadow-xl text-center hover:scale-105 transition">
                            <h3 className="text-2xl font-semibold text-white mb-2">Precision Crafting</h3>
                            <p className="text-gray-400">Every piece is carefully molded and finished to perfection.</p>
                        </div>
                        <div className="bg-gradient-to-tr from-gray-800 to-gray-700 p-8 rounded-2xl shadow-xl text-center hover:scale-105 transition">
                            <h3 className="text-2xl font-semibold text-white mb-2">Innovative Design</h3>
                            <p className="text-gray-400">Modern, sleek, and fully customizable designs that stand out.</p>
                        </div>
                        <div className="bg-gradient-to-tr from-gray-800 to-gray-700 p-8 rounded-2xl shadow-xl text-center hover:scale-105 transition">
                            <h3 className="text-2xl font-semibold text-white mb-2">Durability</h3>
                            <p className="text-gray-400">Materials that last, designed to withstand daily use without compromise.</p>
                        </div>
                    </div>
                </div>
            ),
        },
        {
            ...
            content: (
                <div className="w-full h-full flex flex-col items-center justify-center px-6 lg:px-20 space-y-12">
                    <h2 className="text-5xl font-extrabold text-white">Global Reach</h2>
                    <p className="text-xl text-gray-300 max-w-3xl text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-6">
                        <div className="bg-gradient-to-tr from-gray-800 to-gray-700 p-8 rounded-2xl shadow-xl text-center hover:scale-105 transition">
                            ...
                            <p className="text-gray-400">Quick delivery and local support across the continent.</p>
                        </div>
                        <div className="bg-gradient-to-tr from-gray-800 to-gray-700 p-8 rounded-2xl shadow-xl text-center hover:scale-105 transition">
                            <h3 className="text-2xl font-semibold text-white mb-2">Europe</h3>
                            <p className="text-gray-400">Strong partnerships and distribution channels for fast shipping.</p>
                        </div>
                        <div className="bg-gradient-to-tr from-gray-800 to-gray-700 p-8 rounded-2xl shadow-xl text-center hover:scale-105 transition">
                            <h3 className="text-2xl font-semibold text-white mb-2">Asia-Pacific</h3>
                            <p className="text-gray-400">Global manufacturing reach with consistent quality assurance.</p>
                        </div>
                    </div>
                </div>
            ),
        },
        {
            ...
            content: (
                <div className="w-full h-full flex flex-col items-center justify-center px-6 text-center space-y-6">
                    <h2 className="text-5xl font-extrabold text-white">Partner With Us</h2>
