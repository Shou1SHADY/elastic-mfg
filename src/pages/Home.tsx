                ...
                <div className="max-w-6xl mx-auto px-6 md:px-12">
                    ...
                    >
                        <CometCard rotateDepth={15} translateDepth={15} className="group">
                            <div className="relative h-64 rounded-2xl bg-gradient-to-br from-[#0a0f1c] to-[#141923] border border-white/10 p-6 flex flex-col justify-between hover:border-elastic-accent/50 transition-all duration-300">
                                <div className="w-12 h-12 rounded-full bg-elastic-accent/20 flex items-center justify-center group-hover:bg-elastic-accent/30 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p className="text-zinc-400 text-sm">Advanced manufacturing with micron-level accuracy and automated quality control.</p>
                                </div>
                            </div>
                        </CometCard>

                        <CometCard rotateDepth={15} translateDepth={15} className="group">
                            <div className="relative h-64 rounded-2xl bg-gradient-to-br from-[#0d1117] to-[#1a1f2e] border border-white/10 p-6 flex flex-col justify-between hover:border-elastic-accent/50 transition-all duration-300">
                                <div className="w-12 h-12 rounded-full bg-elastic-secondary/20 flex items-center justify-center group-hover:bg-elastic-secondary/30 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p className="text-zinc-400 text-sm">From prototype to 500k+ units with consistent quality and on-time delivery.</p>
                                </div>
                            </div>
                        </CometCard>

                        <CometCard rotateDepth={15} translateDepth={15} className="group">
                            <div className="relative h-64 rounded-2xl bg-gradient-to-br from-[#141923] to-[#1e2433] border border-white/10 p-6 flex flex-col justify-between hover:border-elastic-accent/50 transition-all duration-300">
                                <div className="w-12 h-12 rounded-full bg-elastic-highlight/20 flex items-center justify-center group-hover:bg-elastic-highlight/30 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p className="text-zinc-400 text-sm">Worldwide distribution network with real-time tracking and customs management.</p>
                                </div>
                            </div>
                        </CometCard>
                    </motion.div>
